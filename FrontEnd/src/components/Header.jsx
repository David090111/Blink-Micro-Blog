    ...
    <header>
      <div className='flex gap-2 items-center h-16 border-b border-gray-300 px-4'>
        ...
        <div className=' font-bold text-3xl flex items-center shrink-0'>
          ...
          <p className='text-2xl font-medium font-serif text-slate-800 whitespace-nowrop hidden sm:block'> Micro Blog</p>
        </div>
        ...
        <div className='ml-auto flex items-center'>
          ...
          {user ? (
            ...
            <button className='mx-2 bg-gray-800 rounded-md p-2 w-24 text-white' onClick={() => {setShowLoginRegister(true), setSwitchPage(true)}}>Sign in</button>
          )}
        </div>
      </div>
